...
var struct_2632 = let_result1317.getAt(0);
var make_2633 = let_result1317.getAt(1);
var __p2634 = let_result1317.getAt(2);
var __ref2635 = let_result1317.getAt(3);
var __set_bang_2636 = let_result1317.getAt(4);
var let_result1318 = M0.values(struct_2632, make_2633, __p2634, M0.make_struct_field_accessor(__ref2635, 0, $rjs_core.PrimitiveSymbol.make("red")), M0.make_struct_field_accessor(__ref2635, 1, $rjs_core.PrimitiveSymbol.make("green")), M0.make_struct_field_accessor(__ref2635, 2, $rjs_core.PrimitiveSymbol.make("blue")), M0.make_struct_field_accessor(__ref2635, 3, $rjs_core.PrimitiveSymbol.make("alpha")));
...
var cl1319 = function(a2637, b2638, c2639) {
    if (arguments.length !== 3) {
        throw $rjs_core.racketContractError("arity mismatch");
    } else {}
    return color1(a2637, b2638, c2639, 255);
};
var cl1320 = function(a2640, b2641, c2642, d2643) {
    if (arguments.length !== 4) {
        throw $rjs_core.racketContractError("arity mismatch");
    } else {}
    return color1(a2640, b2641, c2642, d2643);
};
...
var string__gt_color = function(color_string2644) {
    if (arguments.length !== 1) {
        throw $rjs_core.racketContractError("arity mismatch");
    } else {}
    return __times_color_table_times_[M0.string_downcase(color_string2644)];
};
var color__gt_web_color = function(color2645) {
    if (arguments.length !== 1) {
        throw $rjs_core.racketContractError("arity mismatch");
    } else {}
    return M0.format($rjs_core.UString.make("rgba(~a,~a,~a,~a)"), color_red(color2645), color_green(color2645), color_blue(color2645), color_alpha(color2645));
};
var string__gt_web_color = function(str2646) {
    if (arguments.length !== 1) {
        throw $rjs_core.racketContractError("arity mismatch");
    } else {}
    return color__gt_web_color(string__gt_color(str2646));
};
